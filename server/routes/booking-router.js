...
router.delete('/reservations', ReservationCtrl.deleteAllReservations)
...
router.delete('/rooms', RoomCtrl.deleteAllRooms)
...
router.delete('/passes', CustomerPassCtr.deleteAllPasses)
